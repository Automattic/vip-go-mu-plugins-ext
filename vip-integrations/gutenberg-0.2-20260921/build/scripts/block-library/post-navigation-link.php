...
function gutenberg_render_block_core_post_navigation_link( $attributes, $content ) {
	...
	$support_styles = '' === $content
		...
		: gutenberg_block_core_post_navigation_link_get_support_styles( $attributes );
 ...
 * }
 */
function gutenberg_block_core_post_navigation_link_get_support_styles( $attributes ) {
