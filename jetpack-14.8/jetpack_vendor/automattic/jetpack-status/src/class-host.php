...
class Host {
	...
	public function is_vip_site() {
		return Constants::is_defined( 'WPCOM_IS_VIP_ENV' ) && true === Constants::get_constant( 'WPCOM_IS_VIP_ENV' ); // Hotfix, see https://github.com/Automattic/jetpack/commit/3287aa706df4b5934960ab12553f979f0836ba2d
	}
